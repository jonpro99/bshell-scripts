...
#jonathan.prough@sas.com
#intended to ease the gap for snapshot controls
#currently Sept 10th 2018 over 80,000 snapshots in AWS at SAS you do the math
#almost all linux servers were not installed with AWS drivers, CLI, python, or even an ec2 user.  Um, this made things very diffacult to work in.
