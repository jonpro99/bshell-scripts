...
wget ec2-52-88-67-59.us-west-2.compute.amazonaws.com/jmp/dynmotd -O /usr/local/bin/dynmotd
...
wget ec2-52-88-67-59.us-west-2.compute.amazonaws.com/jmp/pbis-open-8.2.2.2993.linux.x86_64.rpm.sh -O /tmp/pbis-open-8.2.2.2993.linux.x86_64.rpm.sh
yum clean all 
